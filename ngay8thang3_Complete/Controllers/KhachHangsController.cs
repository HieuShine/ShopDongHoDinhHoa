        ...
        public ActionResult Forgotpass(string email)
        {
            ...
            if (account != null)
            {
                ...
                var mail = new SmtpClient("smtp.gmail.com", 587)
                {
                    ...
                    Credentials = new NetworkCredential("dodinhhoa2001@gmail.com", "ebpgrllbqsfudqsi"),
                    //jjaumghqydtoawsy
                ...
                message.From = new MailAddress("dodinhhoa2001@gmail.com");
                message.ReplyToList.Add("dodinhhoa2001@gmail.com");
