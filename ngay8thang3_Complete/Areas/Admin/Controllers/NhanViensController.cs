    ...
    public class NhanViensController : Controller
    {
        ...
        public ActionResult Index(NhanVienModel nhanvien)
        {
            if (ModelState.IsValid)
            {
                ...
                var useradmin = db.NhanViens.Where(m => m.TenDangNhap == nhanvien.TenDangNhap && m.MatKhau == fpass).FirstOrDefault();
                ...
                {
                    Session["idadmin"] = useradmin.ID;
                    Session["fullnameAdmin"] = useradmin.TenDangNhap;
                    Session["fullnameAd"] = useradmin.HoVaTen;
                    Session["quyen"] = useradmin.Quyen;
